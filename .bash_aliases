...
alias t3='tree -C -L 3 --filelimit 40 --gitignore'
alias t4='tree -C -L 3 --filelimit 40 --gitignore'
alias t5='tree -C -L 5 --filelimit 40 --gitignore'
alias t='tree -C -L 3 --filelimit 40 --gitignore'
alias tt='tree -C -L 4 --filelimit 40 --gitignore'
